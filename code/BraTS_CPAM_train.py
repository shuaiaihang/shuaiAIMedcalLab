...
parser.add_argument('--exp', type=str, default='CPAM', help='exp_name')
...
def pre_train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            mask_ratio = 2 / 3
            with torch.no_grad():
                img_mask, loss_mask = context_mask(img_a, mask_ratio)
    ...
    for epoch in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            with torch.no_grad():
                ...
                # mask_ratio = np.random.uniform(1 / 2, 3 / 4)
...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "./model/CPAM/BraTSin_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/CPAM/BraTSin_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    ...
    shutil.copy('./code/BraTS_CPAM_train.py', self_snapshot_path)
    # -- Pre-Training

...
def self_train(args, pre_snapshot_path, self_snapshot_path):
    ...
    for epoch in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            # logging.info('iteration %d : loss: %03f, loss_l: %03f, loss_u: %03f， loss_ll: %03f, loss_uu: %03f'%(iter_num, loss, loss_l, loss_u, loss_ll, loss_uu))
...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "./model/CPAM/LA_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/CPAM/LA_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    ...
    shutil.copy('./code/LA_CPAM_train.py', self_snapshot_path)
    # -- Pre-Training

...
from utils.test_3d_patch import test_all_case, test_all_case_double
...
snapshot_path = "./model/All/LA_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
test_save_path = "./model/All/LA_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
num_classes = 2
...
image_list = [FLAGS.root_path + "/2018LA_Seg/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
...
def test_calculate_metric():
    ...
    # avg_metric = test_all_case_double(model, image_list, num_classes=num_classes,
    #                            patch_size=(112, 112, 80), stride_xy=18, stride_z=4,
    #                            save_result=False, test_save_path=test_save_path,
    #                            metric_detail=FLAGS.detail, nms=FLAGS.nms)

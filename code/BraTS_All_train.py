...
parser.add_argument('--root_path', type=str, default='data/BraTS2019', help='Name of Dataset')
...
def pre_train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 200 == 0:
                model.eval()
                dice_sample = test_3d_patch.var_all_case_BraTS(model, num_classes=num_classes, patch_size=patch_size,
...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "./model/All/BraTStest_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/All/BraTStest_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    ...
    shutil.copy('./code/BraTS_All_train.py', self_snapshot_path)
    # -- Pre-Training
